...
- Original capture Appetize URL: <https://appetize.io/app/4en46xcjwi45sftvmkshktvsua>
- Original capture GitHub Actions run: <https://github.com/MohamedRed/image-lesson-prototype/actions/runs/27826127928>
- Original capture commit: `abbefd138c0c5cffb9e4d06cd6adedf4a3ece547`
- Fresh preview URLs are generated by every successful Android CI run in the `liive-ride-appetize-preview` artifact.
- Most recent binary revalidation before this metadata update: <https://appetize.io/app/uphcwghgbvuhtmmzs2usq2zd2y> from Android CI run <https://github.com/MohamedRed/image-lesson-prototype/actions/runs/27831865438> (`c5e6a30547e53b026a2f5adbb0b294b19d31d987`).
