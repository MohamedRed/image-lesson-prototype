...
data class LiiveColors(
    ...
    val info: Color, val infoTint: Color, val star: Color,
    ...
    val scrimSubtle: Color, val scrimStrong: Color,
...
val LiiveDarkColors = LiiveColors(
    ...
    info = Aqua400, infoTint = Aqua400.copy(alpha = 0.15f), star = AmberStar,
    ...
    scrimSubtle = Color.Black.copy(alpha = 0.35f),
...
val LiiveLightColors = LiiveColors(
    ...
    info = Aqua700, infoTint = Aqua700.copy(alpha = 0.12f), star = Color(0xFFE0A41F),
